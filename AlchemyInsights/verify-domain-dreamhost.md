...
---
# <a name="verify-your-domain-with-dreamhost"></a>Dreamhost ile etki alanınızı doğrulama
...
Adım [adım yönergeler için bkz. Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-dreamhost) için Dreamhost'ta DNS kayıtları oluşturma.