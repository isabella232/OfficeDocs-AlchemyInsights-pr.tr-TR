...
ms.locfileid: "29495160"
---
# <a name="managed-metadata-service-error-message"></a>Yönetilen Meta veri hizmeti hata iletisi

Terim Deposu açtığınızda hata iletisi görebilirsiniz: "Yönetilen Meta veri hizmeti veya bağlantısı şu anda kullanılamıyor. Uygulama havuzu veya yönetilen meta veri Web hizmeti başlatılmamış. Lütfen sistem yöneticinize başvurun."
