...
**Not:** Yakın zamanda çalışmayı durduran bir cihaz veya uygulamanız varsa, lütfen kısa süre önce planlandığı gibi [3DES şifrelemesini devre dışı bırakmaya](https://docs.microsoft.com/office365/securitycompliance/technical-reference-details-about-encryption) başladığımızı aklınızda bulundurun. Etkilenen cihazları görmek için [SMTP Auth İstemcileri raporuna](https://protection.office.com/mailflow/dashboard) gidin. Yaygın hatalar şunlara benzer olabilir: Kimlik doğrulama başarısız/hatası, TLS başarısızlığı/hatası, Şifreleme algoritması hatası, Algoritma uyuşmazlığı veya Bağlantı kesildi. Sorunu çözmek için:
