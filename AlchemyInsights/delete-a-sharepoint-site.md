...
- Site kalıcı olarak kaldırmak için bkz: [site kalıcı olarak silme](https://docs.microsoft.com/en-us/sharepoint/delete-site-collection#permanently-delete-a-site). URL yeniden kullanmayı planlıyorsanız, bu adım gerekli olacaktır. 
- Bir alt site kaldırmak için [siteyi silebileceği veya alt site quicksteps](https://support.office.com/en-us/article/Delete-a-SharePoint-site-or-subsite-bc37b743-0cef-475e-9a8c-8fc4d40179fb#__bkmkshortcut) bakın
