...
---
# <a name="verify-your-domain-with-namecheap"></a>Namecheap ile etki alanınızı doğrulama
...
Adım [adım yönergeler için bkz. Microsoft 365 için Namecheap'ta DNS](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-namecheap) kayıtları oluşturma.