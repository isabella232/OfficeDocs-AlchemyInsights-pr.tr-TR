...
---
# <a name="verify-your-domain-with-godaddy"></a>Etki alanınızı GoDaddy ile doğrulama
...
Adım adım yönergeler [için Office 365 için GoDaddy'de DNS kayıtları oluşturma'ya](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-godaddy) bakın.