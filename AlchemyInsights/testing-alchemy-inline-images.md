---
title: Alchemy satır içi resimleri test etme
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669412"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="2c28a-102">Etki alanları sayfasına erişme</span><span class="sxs-lookup"><span data-stu-id="2c28a-102">Access the Domains Page</span></span>

<span data-ttu-id="2c28a-103">Etki alanları sayfasına erişmek için aşağıdaki simgeye tıklayın:</span><span class="sxs-lookup"><span data-stu-id="2c28a-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="2c28a-104">Ardından etki alanınızı ekleyebilir, değiştirebilir veya kaldırabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="2c28a-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="2c28a-105">Daha fazla bilgi için [etki ALANLARı SSS](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) bölümüne bakın.</span><span class="sxs-lookup"><span data-stu-id="2c28a-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
