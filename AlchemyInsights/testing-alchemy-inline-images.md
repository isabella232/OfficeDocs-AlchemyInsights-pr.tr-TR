...
ms.locfileid: "36507183"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="e3e95-102">Etki alanları sayfasında erişim</span><span class="sxs-lookup"><span data-stu-id="e3e95-102">Access the Domains Page</span></span>

<span data-ttu-id="e3e95-103">Etki alanları sayfaya erişmek için yalnızca bu simgesini tıklatın:</span><span class="sxs-lookup"><span data-stu-id="e3e95-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="e3e95-104">Sonra ekleme, değiştirme veya kaldırma, etki alanı.</span><span class="sxs-lookup"><span data-stu-id="e3e95-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="e3e95-105">Daha fazla bilgi için bkz: [etki alanları hakkında SSS.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="e3e95-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
