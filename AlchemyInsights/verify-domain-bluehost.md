...
---
# <a name="verify-your-domain-with-bluehost"></a>Bluehost ile etki alanınızı doğrulayın
...
Adım adım yönergeler [için Office 365 için Bluehost'ta DNS kayıtları oluşturma'ya](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-bluehost) bakın.