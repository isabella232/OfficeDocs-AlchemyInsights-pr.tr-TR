...
- İlk olarak, Teams Canlı Etkinlikleri'nin Ülke [ve Bölgenize uygun olduğunu onaylayın](https://docs.microsoft.com/microsoftteams/teams-live-events/plan-for-teams-live-events#regional-availability); Canlı Etkinlikler henüz bazı ülkelerde desteklenmiyor.  Lisans atadınız ve ilkeler ayardınız ancak yine de Teams Live Event oluşturamazsanız, büyük olasılıkla Canlı Etkinliklerin henüz kullanılabilir olmadığınız bir Ülke veya Bölgedesinizdir.
