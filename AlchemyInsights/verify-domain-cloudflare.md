---
title: Cloudflare ile etki alanınızı doğrulama
ms.author: pebaum
author: pebaum
manager: scotv
ms.audience: Admin
...
---
# <a name="verify-your-domain-with-cloudflare"></a>Cloudflare ile etki alanınızı doğrulama
...
Adım [adım yönergeler için bkz. Microsoft 365 için Cloudflare'de DNS](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-cloudflare) kayıtları oluşturma.