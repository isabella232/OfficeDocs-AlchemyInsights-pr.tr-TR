...
Geçerli bir abonelik için ödeme yapma nasıl değiştirmek istiyorsanız, yönergeleri izleyin [burada](https://docs.microsoft.com/en-us/office365/admin/subscriptions-and-billing/change-payment-method?view=o365-worldwide).
