...
- Güvenlik duvarı, virüsten koruma yazılımı ve proxy ayarlarını kontrol ederek Office uygulamalarının internete erişimini engellemediklerini onaylayın. Lütfen [Office 365 URL’leri ve IP adresi aralıkları](https://docs.microsoft.com/office365/enterprise/urls-and-ip-address-ranges "Office 365 URL’leri ve IP adresi aralıkları") makalesine bakın.

- Güvenlik duvarı, virüsten koruma yazılımı ve proxy ayarlarını kontrol ederek Office uygulamalarının internete erişimini engellemediklerini onaylayın. Lütfen [Office 365 URL’leri ve IP adresi aralıkları](https://docs.microsoft.com/office365/enterprise/urls-and-ip-address-ranges) makalesine bakın.
...
["Üzgünüm, hesabınıza bağlanabiliyoruz. Office'i etkinleştirdiğinizde lütfen daha sonra tekrar deneyin" https://docs.microsoft.com/office/troubleshoot/activation-installation/issue-when-activate-office-from-office-365 hatası]( "Üzgünüz, hesabınıza bağlanamıyorduk. Office'i etkinleştirdiğinizde lütfen daha sonra tekrar deneyin" hatası"