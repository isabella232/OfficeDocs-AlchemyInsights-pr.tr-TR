...
2. **Daha fazla güvenlik seçeneklerini**belirleyin. 
    
3. **İki adımlı doğrulama**altında **iki adımlı doğrulama kümesi** seçin ve yönergeleri izleyin. 
    
İki adımlı doğrulama üzerinde etkinleştirirseniz, her zaman iki form tanımı gerekir.
  
Kişi yönteminizi kaybederseniz, parolanızı tek başına - hesabınıza geri alamazsınız ve onu yeniden erişim kazanmanız için 30 gün sürebilir. 
  
[İki adımlı kimlik doğrulaması](https://go.microsoft.com/fwlink/?linkid=872270)hakkında daha fazla bilgi edinin.
