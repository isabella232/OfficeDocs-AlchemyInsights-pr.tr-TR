...
OneDrive for Business'taki depolama alanınızı artırmak için, **OneDrive for Business Plan 2** veya Office **365 Enterprise E3**içeren bir abonelik seçin. 
  
Microsoft 365 yönetici merkezinde planları değiştirmek için, Ürünlerinizi **Faturalama** \> **[Your products](https://go.microsoft.com/fwlink/p/?linkid=842054)** sayfasına gidin, değiştirmek için aboneliği seçin ve ardından **Yükseltme** sekmesini seçin.
  
Planlar ve OneDrive for Business depolama arasında geçiş hakkında daha fazla bilgi için, [iş planı için farklı bir Microsoft 365'e](https://go.microsoft.com/fwlink/?LinkId=2031117) ve İş Hizmeti Açıklaması için [OneDrive'a](https://go.microsoft.com/fwlink/p/?LinkId-2031122)geçiş bakın.