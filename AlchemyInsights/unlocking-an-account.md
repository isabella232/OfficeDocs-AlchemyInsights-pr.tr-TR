...
2. Kullanıcıyı seçin ve **Diğer Eylemler (...)**’e tıklayın; ardından **Oturum açma durumunu düzenle**’ye tıklayın.

Kendi Kendine Parola Sıfırlama dahil diğer parola sıfırlama senaryoları için bkz. [İş için Microsoft 365 parolalarını sıfırlamamultiple-attempts-to-charge-online-payment-instruments](https://docs.microsoft.com/microsoft-365/admin/add-users/reset-passwords?view=o365-worldwide).
