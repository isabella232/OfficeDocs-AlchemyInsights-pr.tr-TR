...
1. Özel **sekmesinde** Özel **ayarları** açın.
1. Varsayılan istenmeyen **posta filtresi ilkesi genişletin,** **İlkeyi düzenle'ye** tıklayın ve aşağıdaki ayarları belirtin:
    1. **İstenmeyen posta ve toplu işlemler** bölümünde, eşiği 5 veya 6 değerine ayarlayın.
1. **Kaydet**’e tıklayın.
